    ...
    column(
      ...
      box(
        ...
        tags$div(
          ...
          tags$img(src = "img/MuestRal_Web_Banner.png", height = "300px", style = "max-width: 100%; height: auto;"),
